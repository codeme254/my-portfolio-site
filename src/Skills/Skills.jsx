  ...
  return (
    <section className="skills-section" id="skills">
      ...
      <div className="skills-container">
        <Skill
          skillImage={frontendSkill}
          skillName="responsive web design"
          tools="HTML, CSS"
        />
        <Skill
          skillImage={backendSkillImg}
          skillName="back-end web dev"
          tools="NodeJS, express, MongoDB, Mongoose, Firebase"
        />
        <Skill
          skillImage={shellScriptingImg}
          skillName="bash scripting and cli"
          tools="Linux, Bash"
        />
        <Skill
          skillImage={debuggingImg}
          skillName="debugging/bug bounty"
          tools="Chrome, JavaScript"
        />
        <Skill
          skillImage={fullStackImg}
          skillName="high level programming"
          tools="Python (C# coming soon)"
        />
        <Skill
          skillImage={lowLevelImg}
          skillName="low level programming"
          tools="C"
        />
        <Skill
          skillImage={pairProgrammmingImg}
          skillName="pair programming"
          tools="GitHub, vs code liveshare"
        />
        <Skill
